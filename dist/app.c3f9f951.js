...
var navToggle = document.querySelector(".hamburger__container");
...
var gap = document.querySelector(".interval");
...
(0, _nav.default)(); // Setting default values to on invalid input detection
//Also updates the values of assigned variables after each input
//

final.addEventListener("change", function (e) {
...
initial.addEventListener("change", function (e) {
  if (e.target.value <= 0 || e.target.value == isNaN) {
    e.target.value = 0;
...
},{"./nav":"js/nav.js"}],"../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
